...
export const MEMBERS = {
  ...
  seongeunjeon: {
    firstName: 'Seongeun',
    lastName: 'Jeon',
    email: 'tjddms422422@gmail.com',
    kixlabPosition: 'Visiting Researcher',
    img: 'seongeunjeon.jpg',
    affiliation: 'ROKA',
    startYear: 2026,
    startSeason: 'Summer',
  },
  ...
  jihohanankim: {
    ...
    kixlabPosition: 'Visiting Researcher',
    currentPosition: 'M.S. Student at Columbia University',
    img: 'jihohanan.jpg',
  ...
  hyungyushin: {
    ...
    endYear: 2026,
    endSeason: 'Winter',
    currentPosition: 'CTO at AlgorithmLabs',
  ...
  daeheonjeong: {
    ...
    endYear: 2026,
    isAlumni: true,
    msThesis: 'https://kixlab.github.io/website-files/theses/thesis-ms-2026-daeheon.pdf',
  },
  haeseulcha: {
    firstName: 'Haeseul',
    lastName: 'Cha',

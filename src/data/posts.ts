...
export const POSTS: Post[] = [
  {
    ...
    categories: ['award'],
    summary:
      'Our paper ["When Scaffolding Breaks: Investigating Student Interaction with LLM-Based Writing Support in Real-Time K-12 EFL Classrooms"](https://arxiv.org/abs/2512.05506) led by Junho wins a Best Paper Award for [CHI 2026](https://chi2026.acm.org/). Also, our paper ["Evalet: Evaluating Large Language Models by Fragmenting Outputs into Functions"](https://arxiv.org/abs/2509.11206) led by Tae Soo wins an Honorable Mention Award for [CHI 2026](https://chi2026.acm.org/).',
  },
  {
  ...
  },
  {
    ...
    categories: ['publication'],
    summary:
      'Our paper "CUPID: Evaluating Personalized and Contextualized Alignment of LLMs from Interaction" led by Tae Soo has been accepted to [COLM 2025](https://colmweb.org/). Congratulations!',
  },
  {

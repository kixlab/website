...
export const PUBLICATIONS: Publication[] = [
  ...
  },
  {
    ...
    authors: ["Jieun Han", "Haneul Yoo", "Junho Myung", "Minsun Kim", "Hyunseung Lim", "Yoonsu Kim", "Tak Yeon Lee", "Hwajung Hong", MEMBER.juhokim, "So-Yeon Ahn", "Alice Oh"],
    year: 2023,
    venue: 'arXiv preprint',
    topics: ['learning'],
    type: 'preprint',
  ...
  {
    title: "One vs. Multiple: Comprehending Accurate Information from Multiple Erroneous and Inconsistent AI Generations",
    authors: ["Yoonjoo Lee", "Kihoon Son", "Tae Soo Kim", "Jisu Kim", "John Joon Young Chung", "Eytan Adar", MEMBER.juhokim],
    venue: 'FAccT 2024',
    year: 2024,
    topics: ['human-ai-interaction'],
    type: 'conference',
  ...
  {
    title: "EduLive: Re-Creating Cues for Instructor-Learner Interaction in Educational Live Streams with Learners’ Transcript-Based Annotations",
  ...
  },
  {
    ...
    authors: ["Yoonjoo Lee", "Hyeonsu B Kang", "Matt Latzke", MEMBER.juhokim, "Jonathan Bragg", "Joseph Chee Chang", "Pao Siangliulue"],
    venue: 'CHI 2024',
    year: 2024,
    topics: ['human-ai-interaction'],
    type: 'conference',
  ...
  },
  {
    ...
    authors: ["Hyung-Kwon Ko", "Hyeon Jeon", "Gwanmo Park", "Dae Hyun Kim", "Nam Wook Kim", MEMBER.juhokim, "Jinwook Seo"],
    venue: "CHI 2024",
    year: 2024,
  ...
  },
  {
    ...
    authors: ["Seonghyeon Ye", "Doyoung Kim", "Sungdong Kim", "Hyeonbin Hwang", "Seungone Kim", "Yongrae Jo", "James Thorne", MEMBER.juhokim, "Minjoon Seo"],
  ...
  },
  {
    ...
    authors: ["Gionnieve Lim", "Hyunwoo Kim", "Yoonseo Choi", "Toby Jia-Jun Li", "Chinmay Kulkarni", "Hariharan Subramonyam", "Joseph Seering", "Michael S. Bernstein", "Amy X. Zhang", "Elena L. Glassman", "Simon Perrault", MEMBER.juhokim],
    venue: "CSCW SIG",
    year: 2023,
    topics: ['human-ai-interaction'],
    type: 'poster',
  ...
  },
  {
    ...
    authors: ["Jieun Han", "Haneul Yoo", "Yoonsu Kim", "Junho Myung", "Minsun Kim", "Hyunseung Lim", MEMBER.juhokim, "Tak Yeon Lee", "Hwajung Hong", "So-Yeon Ahn", "Alice Oh"],
  ...
  {
    title: "Towards an Experience-Centric Paradigm of Online Harassment: Responding to Calling out and Networked Harassment",
    authors: ["Haesoo Kim", "Juhoon Lee", MEMBER.juhokim, "Jeong-woo Jang"],
    venue: "CHI 2023 Workshop on Combating Toxicity, Harassment, and Abuse in Online Social Spaces",
    year: 2023,
    topics: ['social'],
  ...
  {
    title: "Moderating Customer Inquiries and Responses to Alleviate Stress and Reduce Emotional Dissonance of Customer Service Representatives",
  ...
  },
  {
    ...
    venue: "CHI 2022 Workshop on Integration of Human Factors in Surgery: Interdisciplinary Collaboration in Design, Development, and Evaluation of Surgical Technologies",
    year: 2022,
    topics: ['learning'],
    type: 'workshop',
    links: [
  ...
  },
  {
    ...
    authors: ["Yoonseo Choi", "Toni-Jan Keith Monserrat", "Jeongeon Park", "Hyungyu Shin", "Nyoungwoo Lee", MEMBER.juhokim],
    venue: "CSCW 2020",
    year: 2020,
  ...
  },
  {
    ...
    authors: ["Changhoon Oh", "Seonghyeon Kim", "Jinhan Choi", "Jinsu Eun", "Soomin Kim", MEMBER.juhokim, "Joonhwan Lee", "Bongwon Suh"],
    venue: "DIS 2020",
    year: 2020,
    topics: ['human-ai-interaction'],
    type: 'conference',
  ...
  },
  {
    ...
    authors: ["Joon-Gyum Kim", "Taesik Gong", "Bogoan Kim", "JaeYeon Park", "Woojeong Kim", "Evey Huang", "Kyungsik Han", MEMBER.juhokim, "JeongGil Ko", "Sung-Ju Lee"],
  ...
  },
  {
    ...
    authors: ["Yoonseo Choi", "Hyungyu Shin", "Toni-Jan Keith Monserrat", "Nyoungwoo Lee", "Jeongeon Park", MEMBER.juhokim],
  ...
  {
    title: "Design for Collaborative Information-Seeking: Understanding User Challenges and Deploying ComeTogether Using Collaborative Dynamic Queries",
    authors: ["Sungsoo Ray Hong", "Minhyang (Mia) Suh", "Tae Soo Kim", "Irina Smoke", "Sang-Wha Sien", "Janet Ng", "Mark Zachry", MEMBER.juhokim],
    venue: "CSCW 2019",
    year: 2019,
    topics: ['visualization'],
    type: 'conference',
  ...
  },
  {
    ...
    authors: ["John Joon Young Chung", "Jean Y. Song", "Sindhu Kutty", "Sungsoo Ray Hong", MEMBER.juhokim, "Walter S. Lasecki"],
    venue: "CSCW 2019",
    year: 2019,
    topics: ['crowdsourcing'],
    type: 'conference',
  ...
  {
    title: "Readersourcing an Accurate and Comprehensive Understanding of Health-related Information Represented by Media",
  ...
  },
  {
    ...
    authors: ["Hyunwoo Kim", "Eunyoung Ko", "Donghoon Han", "Sung-chul Lee", "Simon Perrault", "Jihee Kim", MEMBER.juhokim],
    venue: "CHI 2019 Extended Abstracts (Late Breaking Work)",
    year: 2019,
  ...
  },
  {
    ...
    authors: ["Jean Y. Song", "Stephan J. Lemmer", "Michael Xieyang Liu", "Shiyan Yan", MEMBER.juhokim, "Jason J. Corso", "Walter S. Lasecki"],
    venue: "IUI 2019",
    year: 2019,
    topics: ['crowdsourcing'],
    type: 'conference',
  ...
  },
  {
    ...
    type: 'journal',
    links: [
      { url: "https://juhokim.com/files/TiiS-2018-FourEyes.pdf", type: PublicationLinkType.PDF }
    ],
  },
  {
    ...
    links: [
      ...
      { url: "https://www.kixlab.org/files/2018/uist2018-poster-DynamicSlide-poster.pdf", type: PublicationLinkType.PDF },
  ...
  },
  {
    ...
    links: [
      ...
      { url: "https://www.kixlab.org/files/2018/mm2018-workshop-DynamicSlide-slides.pdf", type: PublicationLinkType.PDF },
  ...
  },
  {
    ...
    links: [
      ...
      { url: "https://www.kixlab.org/files/2018/chi2018-lbw-PersonalityDetection-poster.pdf", type: PublicationLinkType.PDF },
  ...
  },
  {
    ...
    authors: ['Sungsoo (Ray) Hong', 'Minhyang (Mia) Suh', 'Nathalie Henry Riche', 'Jooyoung Lee', MEMBER.juhokim, 'Mark Zachry'],
    venue: "CHI 2018",
    year: 2018,
    topics: ['visualization'],
    type: 'conference',
  ...
  },
  {
    ...
    type: 'conference',
    links: [
      { url: "https://dl.acm.org/citation.cfm?id=3134669", type: PublicationLinkType.ACM }
    ],
  },
  {
  ...
  },
  {
    ...
    type: 'conference',
    links: [
      { url: "https://juhokim.com/files/TAICHI2017-VideoScape.pdf", type: PublicationLinkType.PDF }
    ],
  },
  {
    ...
    type: 'poster',
    links: [
      { url: "http://dl.acm.org/citation.cfm?id=3053118", type: PublicationLinkType.ACM }
    ],
  },
  {
    ...
    type: 'poster',
    links: [
      { url: "http://dl.acm.org/citation.cfm?id=3053073", type: PublicationLinkType.ACM }
    ],
  },
  {
    ...
    type: 'poster',
    links: [
      { url: "http://dl.acm.org/citation.cfm?id=3053247", type: PublicationLinkType.ACM }
    ],
  },
  {
    title: "MOOClets: A Framework for Dynamic Experimentation and Personalization",
    authors: ['Joseph Jay Williams', 'Anna Rafferty', 'Samuel Maldonado', 'Andrew Ang', 'Dustin Tingley', MEMBER.juhokim],
    venue: "Learning at Scale 2017 Work-in-Progress",
    year: 2017,
    topics: ['crowdsourcing', 'learning'],
    type: 'poster',
    links: [
      { url: "http://dl.acm.org/citation.cfm?id=3054006", type: PublicationLinkType.ACM }
    ],
  },
  {
    title: "Designing Interactive Distance Cartograms to Support Urban Travelers",
    authors: ['Sungsoo (Ray) Hong', 'Rafal Kocielnik', 'Min-Joon Yoo', 'Sarah Battersby', MEMBER.juhokim, 'Cecilia Aragon'],
    venue: "PacificVis 2017",
    year: 2017,
    topics: ['civics'],
    type: 'conference',
    links: [
      { url: "http://juhokim.com/files/PacificVis2017-DC.pdf", type: PublicationLinkType.PDF }
    ],
  },
  {
    ...
    type: 'workshop',
    links: [
      { url: "http://juhokim.com/files/WWW2017-Workshop-News.pdf", type: PublicationLinkType.PDF }
    ],
  },
  {
    ...
    type: 'workshop',
    links: [
      { url: "http://juhokim.com/files/CSCW2017-Workshop-MicroNGO.pdf", type: PublicationLinkType.PDF }
    ],
  },
  {
    ...
    type: 'conference',
    links: [
      { url: "https://juhokim.com/files/CSCW2017-SCAN.pdf", type: PublicationLinkType.PDF }
    ],
  },
] as const
